<form method="post" action="index.php?c=admin&act=edit&id=<?= $_GET['id'] ?>" class="admin-form"
      enctype="multipart/form-data">
    <p><strong>Редактировать товар:</strong></p>
    <hr>
    <a href="index.php?c=admin&act=del&id=<?= $good['id'] ?>&path=<?= $good['path'] ?>" class="buy-btn">Удалить
        Товар</a>
    <hr>
