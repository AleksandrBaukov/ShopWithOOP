...
<div class="container">
    <header class="header">
        ...
        <div class="slider">
            ...
            <div class="slider-block">
                ...
                <p class="slider-text">Nam liber tempor cum soluta nobis eleifend option congue nihil imper&shy;diet
    ...
    <section class="categories">
        <div class="categories-blocks">
            ...
            <p class="categories-text">Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming
                id&nbsp;quod mazim.</p>
        </div>
        <div class="categories-blocks">
            ...
            <p class="categories-text">Lorem ipsum dolor sit amet, adipiscing elit, sed diam nonummy nibh euismod
    ...
    <main>
        ...
        <p class="main-text">Investigationes demonstraverunt lectores legere me&nbsp;lius quod ii&nbsp;legunt saepius.
            Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium.</p>
        <img src="../public/img/browser-left.png" alt="portfolio image-1" class="main-img-left" width="500"
             height="300">
        <img src="../public/img/browser-right.png" alt="portfolio image-2" class="main-img-right" width="500"
             height="300">
        <img src="../public/img/browser-center.png" alt="portfolio image-3" class="main-img-center" width="500"
             height="300">
    </main>
    ...
    <section class="projects">
        ...
        <div class="projects-blocks">
            <div class="projects-blocks-item">
                ...
                <button class="projects-blocks-item-search">
    ...
    <section class="video">
        ...
        <div class="video-wrp">
            ...
            <p class="video-text">Investigationes demonstraverunt lectores legere me&nbsp;lius quod ii&nbsp;legunt
    ...
    <section class="devices">
        ...
        <div class="devices-block">
            ...
            <p class="devices-text">Qisi enim ad&nbsp;minim veniam, quis nostrud exerci tation ullamcorper suscipit
                lobortis nisl ut&nbsp;aliquip ex&nbsp;ea&nbsp;commodo consequat. Investigationes demonstraverunt
                lectores legere me&nbsp;lius quod ii&nbsp;legunt saepius claritas. Eodem modo typi, qui nunc nobis
            ...
            <ul class="devices-list">
                ...
                <li class="devices-list-item">Option congue nihil imperdiet doming id&nbsp;quod mazim placerat facer;
                </li>
        ...
        <div class="posts-blocks">
            <div class="posts-blocks-item">
                ...
                <div class="posts-blocks-description">
                    ...
                    <p class="posts-blocks-text">Claritas est etiam processus dynamicus, qui sequitur mutationem
                        consuetudium.</p>
                    <a href="#">Read More</a>
                </div>
            </div>
