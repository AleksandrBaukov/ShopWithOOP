        ...
        foreach ($goods as $good) {
            ...
            <div class="projects-blocks-item">
                ...
                <div class="projects-blocks-item-wrp projects-blocks-item-wrp-catalog">
                    ...
                    <p class="projects-blocks-item-wrp-text projects-blocks-item-wrp-text-catalog"><?= $good["price"] ?>
                        $</p>
                    <p><?= $good["smallDesc"] ?></p>
                    <button class="buy-btn" onclick="addProduct(<?= $good["id"] ?>)"><span
                                class="buy-btn-txt">Buy</span>
                    </button>
                </div>
            </div>
            <?
